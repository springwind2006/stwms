...
function menu(act,para){
  switch(act){
    case 'add':
      top.win.diag(ROUTE_C+'.add',{'tl':'添加菜单','w':540,'h':320});
    break;
    case 'sub':
      top.win.diag(ROUTE_C+'.add','pid='+para,{'tl':'添加子菜单','w':540,'h':320});
    break;
    case 'edit':
      top.win.diag(ROUTE_C+'.edit','id='+para,{'tl':'编辑菜单','w':540,'h':320});
    break;    
  }
}
