...
return array(
		...
		'db_conn' => 'mysqli', // 系统启用的数据库连接配置，数据库连接在database.cfg.php文件中配置
		...
		//前端配置设置
		'db_conn_type' => 'mysql', // 系统启用的数据库连接配置，数据库连接在database.cfg.php文件中配置
		'template' => 'flycloud', // 前台模板名称，位于template/目录
		'static' => 'default/', // 前台访问静态文件路径，如果为相对路径则相对于STATIC_URL/styles
		'html_root' => 'redsun/', // 静态文件生成路径，相对于网站根目录
