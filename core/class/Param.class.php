...
class Param{
	...
	public function check(){
		 ...
		 */
		if(empty($c) && empty($a) && ($plugin_c=$this->get_para('plugin_c'))){
			if(defined('ADMIN_INI')){
				$c='plugin';
				$a='admin';
			}elseif(!defined('SYSTEM_PLUGIN_CALLEE')){
				$c=$plugin_c;
				$a=$this->get_para('plugin_a', 'index');
				define('SYSTEM_PLUGIN_CALLEE',true);
			}
	...
	// 获取参数，非空值
	public static function get_para($para,$default='',$func=null){
