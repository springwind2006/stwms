<?php
/*
 * 说明： 1.此类需要php5.0以上版本 2.此类用于操作MsSQL数据库,php.ini要求扩展php_mssql.dll模块
 */
...
class MssqliDb extends Db implements DbInterface{
	...
	/*
	 * 功能:查询数据API 1.'select'语句放回查询的记录数组; 2.$ifMod说明是否需要标示查询字段; 注意:此为最原始查询方法，不做表名前置处理, 由于传递给$sql需要转码为GB2312从而解决数据入口问题
	 */
