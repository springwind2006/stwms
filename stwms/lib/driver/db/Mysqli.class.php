 ...
 * 说明：
 * 1.此类需要php5.0以上版本
 * 2.此类用于操作MsSQL数据库,php.ini要求扩展php_mysqli.dll模块
 * 3.此类支持事件回溯功能
 */
...
// /--------------附加说明信息----------------
/*
 * getFdInfo($tb,$fd)方法相关说明：
 * flags映射-> NOT_NULL:1 PRI_KEY:2 UNIQUE_KEY:4 MULTIPLE_KEY:8 BLOB:16 UNSIGNED:32 ZEROFILL:64 AUTO_INCREMENT:512 TIMESTAMP:1024 SET:2048 NUM:32768 PART_KEY:16384 GROUP:32768
 * type映射-> DECIMAL:0 TINY:1 SHORT:2 LONG:3 FLOAT:4 DOUBLE:5 NULL:6 TIMESTAMP:7 LONGLONG:8 INT24:9 DATE:10 TIME:11 DATETIME:12 YEAR:13 NEWDATE:14 ENUM:247 SET:248 TINY_BLOB:249 MEDIUM_BLOB:250 LONG_BLOB:251 BLOB:252 VAR_STRING:253 STRING:254 CHAR:1 INTERVAL:247 GEOMETRY:255 NEWDECIMAL:246 BIT:16
 */
?>