...
class Uploadfile{
	 ...
	 * )
	 * 说明：
	 * $attachment_setting参数 (缩略图宽度,缩略图高度，剪裁类型，是否水印，是否md5值校验)
	 */
	...
	/**
	 * 功能：判断文件是否是通过 HTTP POST 上传的
	 * 参数：(string $file 文件地址)
	 * 返回：bool 所给出的文件是通过 HTTP POST 上传的则返回 TRUE
	 */
	...
	/**
	 * 功能：补全网址
	 * 参数：(string $surl 源地址, string $absurl 相对地址, string $basehref 网址)
	 * 返回：string 网址
	 */
