...
class Form{
	...
	/**
	 * 功能：生成多图上传
	 * 参数：($name 表单名称,$id 表单id,$value 表单默认值,$moudle 模块名称,$catid 栏目id,$size 表单大小,
	 * $class 表单风格,$ext 表单扩展属性 如果 js事件等,$alowexts 允许图片格式,
	 * $thumb_setting 缩略图设置,$watermark_setting 0或1)
	 */
	 ...
	 * int $size 表单大小,
	 * string $class 表单风格,
	 * string $ext 表单扩展属性 如果 js事件等,
	 * string $alowexts 允许图片格式,
	 * array $file_setting
	 * )
	 */
	 ...
	 * $name 控件name，id,
	 * $value 默认为空,选中值,
	 * $isdatetime 默认为0 是否显示时间,
	 * $isForm 默认为1 是否生成表单,
	 * $showweek 默认为1 是否显示周
	 * $timesystem 时间系统:1->24小时制,0->12小时制，默认为1
	 * )
	 */
	 ...
	 * 参数：(
	 * string $file 栏目缓存文件名,
	 * intval/array $catid 别选中的ID，多选是可以是数组,
	 * string $str 属性,
	 * string $default_option 默认选项,
	 * intval $modelid 按所属模型筛选,
	 * intval $type 栏目类型,
	 * intval $onlysub 只可选择子栏目,
	 * intval $siteid 如果设置了siteid 那么则按照siteid取
	 * )
	 */
