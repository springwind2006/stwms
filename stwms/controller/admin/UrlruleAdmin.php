...
class UrlruleAdmin extends AdminController{
	...
	/**
	 * 功能：设置选择结果中的带有catid字段的url
	 * 参数：(&$data array 数据,$page=0 int 页数,
	 * $pagetype='page' string 分页类别,$isset=1 bool 是否设置URL到数据)
	 */
	...
	/**
	 * 功能：设置或获取栏目页URL
	 * 参数：(&$category array 栏目配置,$page=0 int 页数,$typeid='' int 分类ID,
	 * $pagetype='page' string 分页类别,$isfull=1 bool 是否返回全路径)
	 */
	//
