...
class AttachmentHome extends HomeController{
	...
	public function swfupload(){
		...
		if(!empty($_FILES[$field])){
			...
			$aids=$uploadfile->upload($field, $_POST['filetype_post'], intval($_POST['file_size_limit']) * 1024, 0, array(intval($_POST['thumb_width']),intval($_POST['thumb_height']),intval($_POST['auto_cut']),intval($_POST['watermark_enable']),intval($_POST['md5_check'])));
